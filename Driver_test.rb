...
def test_names
  d1 = Driver.new("Doug",Random.new(0))
  d2 = Driver.new("Bambi",Random.new(0))
  d3 = Driver.new("Meg",Random.new(0))
  d4 = Driver.new("Cyan",Random.new(0))
  d5 = Driver.new("55010",Random.new(0))
...
def test_start_loc
  d = Driver.new("Doug",Random.new(0))
...
def test_attend_class
  real = Driver.new("Tom",Random.new(0))
...
def test_identical_seeds
  ...
  d1 = Driver.new("Clark",Random.new(s1.arg))
  d2 = Driver.new("Kent",Random.new(s2.arg))
